<template>
  <div class="register-admin">
      ...
      <div class="register-tel">
        ...
        <!-- 输入密码 -->
        <div class="register-password"><input type="password" placeholder="请输入密码"><a href="javascript:;">忘记密码?</a></div>
        <!-- 登录按钮 -->
        <button>登录</button>
        <!-- 输入验证码 -->
        <!-- <van-password-input
        ...
        <!-- <van-number-keyboard
            ...
            /> -->
            <!-- 账号密码登录 -->
        <a href="javascript:;" class="register-login" >手机验证码登录</a>
